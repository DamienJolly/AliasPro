...
{
    public class GetModeratorUserChatlogEvent : IAsyncPacket
    {
        public short Header { get; } = Incoming.GetModeratorUserChatlogMessageEvent;
        
        private readonly IRoomController _roomController;

        public GetModeratorUserChatlogEvent(
