...
{
    public class WiredInteractionFurniHavePlayer : WiredInteraction
    {
        private static readonly WiredConditionType _type = WiredConditionType.FURNI_HAVE_HABBO;

        public WiredInteractionFurniHavePlayer(IItem item)
            : base(item, (int)_type)
        {
