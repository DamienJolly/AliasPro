...
{
    public class WiredInteractionNotPlayerOnFurni : WiredInteraction
    {
        private static readonly WiredConditionType _type = WiredConditionType.NOT_ACTOR_ON_FURNI;

        public WiredInteractionNotPlayerOnFurni(IItem item)
            : base(item, (int)_type)
        {
