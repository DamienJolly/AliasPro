...
{
    public class WiredInteractionPlayerInTeam : WiredInteraction
    {
        private static readonly WiredConditionType _type = WiredConditionType.ACTOR_IN_TEAM;

        public WiredInteractionPlayerInTeam(IItem item)
            : base(item, (int)_type)
        {
