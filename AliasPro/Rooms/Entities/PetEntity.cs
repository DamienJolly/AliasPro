...
namespace AliasPro.Rooms.Entities
{
    ...
    {
        internal PetEntity(int petId, uint ownerId, string ownerUsername, int id, int x, int y, int rotation, IRoom room, string name, string figure, PlayerGender gender, string motto, int score)
